...
这个仓库汇集了一系列精心编写的、手把手教你从零开始重新实现你最喜欢的技术的指南。

> *凡我不能创造的，我便还没有真正理解。—— 理查德·费曼*
...
* [AI 模型](#ai-模型)
* [增强现实](#从零构建增强现实)
* [BitTorrent 客户端](#从零构建-bittorrent-客户端)
* [区块链 / 加密货币](#从零构建区块链--加密货币)
* [机器人（Bot）](#从零构建机器人bot)
* [命令行工具](#从零构建命令行工具)
* [数据库](#从零构建数据库)
* [Docker](#从零构建-docker)
...
* [视觉识别系统](#从零构建视觉识别系统)
* [体素引擎](#从零构建体素引擎)
* [Web 浏览器](#从零构建-web-浏览器)
* [Web 服务器](#从零构建-web-服务器)
* [未分类](#未分类)

## 教程

#### 从零构建 `分布式系统`
* [**Java**: _从零构建类 Kafka 系统的分步指南_](https://github.com/buildthingsuseful/build-your-own-kafka)
...
* [**C#**: _How To: Augmented Reality App Tutorial for Beginners with Vuforia and Unity 3D_](https://www.youtube.com/watch?v=uXNjNcqW4kY) [视频]
* [**C#**: _How To Unity ARCore_](https://www.youtube.com/playlist?list=PLKIKuXdn4ZMjuUAtdQfK1vwTZPQn_rgSv) [视频]
* [**C#**: _AR Portal Tutorial with Unity_](https://www.youtube.com/playlist?list=PLPCqNOwwN794Gz5fzUSi1p4OqLU0HTmvn) [视频]
* [**C#**: _How to create a Dragon in Augmented Reality in Unity ARCore_](https://www.youtube.com/watch?v=qTSDPkPyPqs) [视频]
* [**C#**: _How to Augmented Reality AR Tutorial: ARKit Portal to the Upside Down_](https://www.youtube.com/watch?v=Z5AmqMuNi08) [视频]
...
* [**(任意语言)**: _Linux from scratch_](https://linuxfromscratch.org/lfs)
...
* [**(任意语言)**: _mal - Make a Lisp_](https://github.com/kanaka/mal#mal---make-a-lisp)
...
* [**(任意语言)**: _From NAND to Tetris: Building a Modern Computer From First Principles_](http://nand2tetris.org/)
* [**(任意语言)**:  build-your-own-x-vibe-coding: BYOX-style tutorials adapted for vibe coding](https://github.com/inFaaa/build-your-own-x-vibe-coding)
...
## 贡献
* 欢迎投稿，只需发送 PR，或[创建 Issue](https://github.com/codecrafters-io/build-your-own-x/issues/new)
* 欢迎通过留下评论和"表情反应"来帮助我们审核[待处理的投稿](https://github.com/codecrafters-io/build-your-own-x/issues)

## 起源与许可

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

本仓库由[众多贡献者](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors)共同完成。最初由 [Daniel Stefanovic](https://github.com/danistefanovic) 创建，现由 [CodeCrafters, Inc.](https://codecrafters.io) 维护。在法律允许的范围内，[CodeCrafters, Inc.](https://codecrafters.io) 已放弃对本作品的所有版权及相关权利。
